Unit MyTCPinterfaceForKolibrikPTC;
...
type
  ...
  public
      ...
      function PTCQueryLowLVL (cmd: string; Var reply: string; tottimeout: longint): boolean;
 ...
 //     Function Ptc_IsConnected: boolean;
      function ReadPTCServer ReadPTCDataStatus(Var chdata: TKolPTCChannelData; Var st: TKolPTCStatus): boolean;
