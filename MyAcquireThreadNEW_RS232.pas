...
type
  ...
  TAcquireThreadV2_RS232 = class (TAquireThreadBaseV2)       //TMultiReadExclusiveWriteSynchronizer
  //!!!!!NOTE!!!!
...
constructor TAcquireThreadV2_RS232.Create( UserExecute: TMyExecuteMethod; client: TComPortThreadSafe; log: TLoggerThreadSafeNew; OnCLiStatChange: TMyExecuteMethod);
begin
...
destructor TAcquireThreadV2_RS232.Destroy;
begin
  //fTCPsynchro.Destroy;
  TerminateAndWaitForExecuteFinish;  //IMPORTASNT WAIT FOR THIS/ANCESTOR THREAD
...
procedure TAcquireThreadV2_RS232.ProcessConfigurationRequests;
...
procedure TAcquireThreadV2_RS232.OpenClient;      //called from main thread, must not block
begin
  fOpenRequested.valBool := true;
end;


procedure TAcquireThreadV2_RS232.CloseClient;               //called from main thread, must not block
begin
  fCloseRequested.valBool := true;
end;


procedure TAcquireThreadV2_RS232.ResetConnection;
begin
...
procedure TAcquireThreadV2_RS232.ConfigureClient( portconf: TComPortConf);
