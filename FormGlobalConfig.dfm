object GlobalConfig: TGlobalConfig
  ...
  object chkAutoInit: TCheckBox
    Left = 592
    Top = 120
    Width = 297
    Height = 33
    Caption = 'Auto Init Deviceas at start'
    TabOrder = 12
    OnClick = chkAutoInitClick
  end
  object chkTurnPTCOffZeroI: TCheckBox
    Left = 592
    Top = 160
    Width = 297
    Height = 33
    Caption = 'Turn PTC OFF for ZERO current setpoint'
    TabOrder = 13
    OnClick = chkTurnPTCOffZeroIClick
  end
  object chkReopenLastProj: TCheckBox
    Left = 592
    Top = 200
    Width = 297
    Height = 33
    Caption = 'REOPEN last project after start'
    TabOrder = 14
    OnClick = chkReopenLastProjClick
  end
